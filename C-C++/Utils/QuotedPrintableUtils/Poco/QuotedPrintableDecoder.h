...
class Foundation_API QuotedPrintableDecoderBuf: public Poco::UnbufferedStreamBuf
...
class Foundation_API QuotedPrintableDecoderIOS: public virtual std::ios
...
class Foundation_API QuotedPrintableDecoder: public QuotedPrintableDecoderIOS, public std::istream

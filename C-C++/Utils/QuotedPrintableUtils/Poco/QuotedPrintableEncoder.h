...
class Foundation_API QuotedPrintableEncoderBuf: public Poco::UnbufferedStreamBuf
...
class Foundation_API QuotedPrintableEncoderIOS: public virtual std::ios
...
class Foundation_API QuotedPrintableEncoder: public QuotedPrintableEncoderIOS, public std::ostream

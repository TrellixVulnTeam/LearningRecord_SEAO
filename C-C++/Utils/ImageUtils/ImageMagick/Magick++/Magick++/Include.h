...
#          pragma comment(lib, "CORE_cairo.lib")
#        endif
#        if defined(MAGICKCORE_OPENEXR_DELEGATE)
#          pragma comment(lib, "CORE_exr.lib")
#        endif
#        if defined(MAGICKCORE_FLIF_DELEGATE)
#          pragma comment(lib, "CORE_flif.lib")
#        endif
#        if defined(MAGICKCORE_FREETYPE_DELEGATE)
#          pragma comment(lib, "CORE_freetype.lib")
#        endif
...
#          pragma comment(lib, "CORE_jpeg-turbo.lib")
#        endif
#        if defined(MAGICKCORE_JXL_DELEGATE)
#          pragma comment(lib, "CORE_highway.lib")
#          pragma comment(lib, "CORE_brotli.lib")
#          pragma comment(lib, "CORE_jpeg-xl.lib")
#        endif
#        if defined(MAGICKCORE_LCMS_DELEGATE)
#          pragma comment(lib, "CORE_lcms.lib")
#        endif
#        if defined(MAGICKCORE_HEIC_DELEGATE)
#          pragma comment(lib, "CORE_aom.lib")
#          pragma comment(lib, "CORE_libde265.lib")
#          pragma comment(lib, "CORE_libheif.lib")
#        endif
#        if defined(MAGICKCORE_LZMA_DELEGATE)
#          pragma comment(lib, "CORE_liblzma.lib")
#        endif
#        if defined(MAGICKCORE_RAW_R_DELEGATE)
#          pragma comment(lib, "CORE_libraw.lib")
#        endif
#        if defined(MAGICKCORE_RSVG_DELEGATE)
#          pragma comment(lib, "CORE_croco.lib")
#          pragma comment(lib, "CORE_librsvg.lib")
#        endif
#        if defined(MAGICKCORE_XML_DELEGATE)
#          pragma comment(lib, "CORE_libxml.lib")
#        endif
#        if defined(MAGICKCORE_ZIP_DELEGATE)
#          pragma comment(lib, "CORE_libzip.lib")
#        endif
#        if defined(MAGICKCORE_LQR_DELEGATE)
#          pragma comment(lib, "CORE_ffi.lib")
#          pragma comment(lib, "CORE_glib.lib")
#          pragma comment(lib, "CORE_lqr.lib")
#          pragma comment(lib, "winmm.lib")
#        endif
#        if defined(MAGICKCORE_LIBOPENJP2_DELEGATE)
#          pragma comment(lib, "CORE_openjpeg.lib")
#        endif
#        if defined(MAGICKCORE_PANGOCAIRO_DELEGATE)
#          pragma comment(lib, "CORE_fribidi.lib")
#          pragma comment(lib, "CORE_harfbuzz.lib")
#          pragma comment(lib, "CORE_pango.lib")
#          pragma comment(lib, "CORE_pixman.lib")
#        endif
...
#          pragma comment(lib, "CORE_webp.lib")
#        endif
...
#        pragma comment(lib, "CORE_MagickCore.lib")
#        pragma comment(lib, "CORE_MagickWand.lib")
//#      if defined(_DEBUG)
//#        if defined(MAGICKCORE_BZLIB_DELEGATE)
